package aula.rest_controller.repository;  // Pacote onde a classe está localizada

import aula.rest_controller.model.Usuario;  // Importando a classe Usuario
import org.springframework.stereotype.Repository;  // Importando a anotação @Repository para marcar a classe como um repositório

import java.util.ArrayList;  // Importando ArrayList para criar listas
import java.util.List;  // Importando List para manipulação de listas de usuários
