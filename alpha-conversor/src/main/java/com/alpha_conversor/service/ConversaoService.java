package com.alpha_conversor.service;

import com.alpha_conversor.configuration.ApiConfig;
...
public class ConversaoService {
    ...
    private static final String API_KEY = ApiConfig.API_KEY;  // Usando a chave da classe ApiConfig
