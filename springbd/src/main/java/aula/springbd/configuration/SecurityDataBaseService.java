...
import aula.springbd.model.Usuario;
import aula.springbd.repository.UsuarioRepository;
...
@Service
public abstract class SecurityDataBaseService {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            ...
            return User.builder()
                    ...
                    .roles("user", "admin")  // Aqui você pode adicionar as roles adequadas do seu usuário
                    .build();
        };
    }
